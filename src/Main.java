...
public class Main {
    ...
    public static int[] numChecking() {
        ...
        while (!isValidNum1) {
            System.out.println("""
                    ======================================================================================
                    Step 2: Please type in two int values step by step (range between -2,147,483,647 to 2,147,483,647):
        ...
        while (!isValidNum2) {
            System.out.println(" - Please type your SECOND int value:");
    ...
    public static String inputFileName () {
        ...
        while (!isValidInput) {
            System.out.println("""
                ======================================================================================
                Please input a valid name for your INPUT File:
    ...
    public static String outputFileName () {
        ...
        while (!isValidOutput) {
            System.out.println("""
                ======================================================================================
                Please input a valid name for your OUTPUT File:
                 - The file name can't include: <, >, :, ", /, \\, |, ?, *
                """);
